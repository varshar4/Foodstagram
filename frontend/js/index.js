...
if(signUp){signUp.onclick=function(){modal.style.display="block"
signForm.style.display="block"
logForm.style.display="none"}}
if(logIn){logIn.onclick=function(){modal.style.display="block"
...
function checkModals(modalNum){if(modalNum===1){modal.style.display="block"
signForm.style.display="block"
logForm.style.display="none"}else if(modalNum===2){modal.style.display="block"
signForm.style.display="none"
logForm.style.display="block"}}
function postClick(image,title,caption,user){pmodal.style.display="block"
