...
if(postButton){postButton.onclick=function(){if(newPostModal.style.display!="grid"){newPostModal.style.display="grid"}}}
...
pfpButton.onclick=function(){if(pfpModal.style.display!="grid"){pfpModal.style.display="grid"}}
pfpModal.onclick=function(event){if(event.targe==pfpModal){pfpModal.style.display="none"}}
pfpImageSrc.addEventListener("change",function(){const files=pfpImageSrc.files
if(files.length==0){pfpUploadedImage.src=""
pfpUploadedImage.style.backgroundColor="black"}else{const file=files[0]
...
followers.onclick=function(){followModal.style.display="block"
followerDiv.style.display="block"
followDiv.style.display="none"}
following.onclick=function(){followModal.style.display="block"
